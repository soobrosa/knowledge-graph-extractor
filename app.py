...
<meta property="og:description" content="Turn any document or a whole zip into an interactive knowledge graph, locally on an Apple Silicon Mac. Entity-linked triples, semantic dedup, live force-directed graph, JSONL export.">
...
<script>
// API base: works at the server root ("/") and behind a reverse proxy subpath
